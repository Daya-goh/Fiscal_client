...
function LandingPage() {
  ...
  return (
    <>
      <div
        className="hero min-h-full py-6"
        style={{
      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <p className="py-6">
            We have simplified the process of tracking expenses for you. All you need to do is to key
            in your income, fixed expenditures, savings once, log in your
            expenses, and we will take care of the rest for you.
          </p>
          <button
            onClick={() => navigate("/signup")}
            className="btn btn-primary"
